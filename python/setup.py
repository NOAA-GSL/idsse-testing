...
setup(
    ...
    data_files=[
        ("idsse.testing.idsse_common", package_files("idsse/testing/idsse_common/")),
        (
            "idsse.testing.data_access.data_cache",
            package_files("idsse/testing/data_access/data_cache"),
        ),
        (
            "idsse.testing.data_access.mrms_nssl_grib",
            package_files("idsse/testing/data_access/mrms_nssl_grib"),
        ),
        (
            "idsse.testing.data_access.nbm_aws_grib",
